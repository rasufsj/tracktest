...
pre_input="export UAV_NAME=uav1; export RUN_TYPE=simulation; source /home/cyros/catkin_ws/devel/setup.bash"
...
"
  'Spawner' "waitForSpawner; roslaunch mrs_uav_gazebo_simulation mrs_drone_spawner.launch
"
  'Spawn' "waitForSimulation; rosservice call /mrs_drone_spawner/spawn \"1 --pos 5 2 2.5 0 0.78 --f450  --enable-rangefinder --enable-rangefinder-up --enable-rplidar --enable-ground-truth --enable-bluefox-camera --enable-realsense-front\"
"
  'Control' "waitForOdometry; roslaunch mrs_uav_core core.launch config_uav_manager:=./custom_configs/uav_manager.yaml
"
  'AutomaticStart' "waitForSimulation; roslaunch mrs_uav_autostart automatic_start.launch
"
